    ...
    <div class="tw-container tw-mx-auto tw-grid tw-grid-cols-4 tw-gap-30px">
        <div class="tw-col-span-3">
            <div class="tw-flex tw-items-center tw-gap-40px">
                <div
                    class="tw-flex tw-items-center tw-gap-20px tw-rounded-5px tw-border-1px tw-border-gray4 tw-bg-white tw-px-16px tw-py-18px">
                    <svg class="tw-cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        viewBox="0 0 20 20" fill="none">
                        <rect width="5.45455" height="5.45459" fill="#80B4FF" />
                        <rect x="7.5" y="1.875" width="12.5" height="1.25001" fill="#80B4FF" />
                        <rect x="7.5" y="9.375" width="12.5" height="1.25001" fill="#80B4FF" />
                        <rect x="7.5" y="16.875" width="12.5" height="1.25001" fill="#80B4FF" />
                        <rect y="7.27295" width="5.45455" height="5.45459" fill="#80B4FF" />
                        <rect y="14.5454" width="5.45455" height="5.45459" fill="#80B4FF" />
                    </svg>
                    <svg class="tw-cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        viewBox="0 0 20 20" fill="none">
            ...
            <div class="tw-mt-50px tw-grid tw-grid-cols-3 tw-gap-30px">
                @for ($i = 0; $i < 9; $i++)
                    <x-global.card />
                @endfor
            </div>
