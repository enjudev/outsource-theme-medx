<section id="headerMobile" class="tw-block lg:tw-hidden">
    <div class="tw-fixed tw-left-0 tw-top-0 tw-z-[200] tw-flex tw-w-full tw-bg-white tw-px-15px tw-py-15px">
        <a href="" class="tw-h-auto tw-w-150px">
            <img src="{{ asset('assets/Logo.svg') }}" class="object-contain" alt="" />
        </a>
        <div class="tw-ml-auto">
            <button class="" type="button" data-drawer-target="mobileDrawer" data-drawer-show="mobileDrawer"
...
<div id="mobileDrawer"
    class="tw-fixed tw-left-0 tw-top-0 tw-z-[300] tw-h-screen tw-w-[320px] -tw-translate-x-full tw-bg-white tw-p-16px tw-transition-transform dark:tw-bg-gray-800"
    tabindex="-1" aria-labelledby="drawer-label">
    <h5 id="drawer-label"
        class="inline-flex items-center mb-4 text-base font-semibold text-gray-500 dark:text-gray-400">Medx</h5>
