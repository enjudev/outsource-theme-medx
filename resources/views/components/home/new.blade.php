<section id="new" class="tw-bg-cover tw-bg-no-repeat tw-py-100px"
    ...
    <div class="tw-container tw-mx-auto tw-grid tw-grid-cols-1 tw-gap-30px tw-px-15px lg:tw-grid-cols-4 lg:tw-px-0">
        <div>
            ...
            <p
                class="tw-mt-4px tw-text-start tw-text-48px tw-font-semibold tw-capitalize tw-leading-52px tw-text-white">
                Latest News
            </p>
            <p class="tw-mt-20px tw-text-base tw-leading-24px tw-text-white">Lorem ipsum dolor sit amet, consectetuer
                adipiscing
                ...
                vero eros et </p>
            <div class="tw-mt-20px tw-flex tw-items-center tw-gap-4px">
                <svg class="new-item-prev" xmlns="http://www.w3.org/2000/svg" width="33" height="32"
                    viewBox="0 0 33 32" fill="none">
                    <g clip-path="url(#clip0_1_1120)">
                        <path d="M10.1299 16H24.7965" stroke="#D9D9D9" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M10.1299 16L15.4632 21.3333" stroke="#D9D9D9" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M10.1299 16.0003L15.4632 10.667" stroke="#D9D9D9" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </g>
                    <defs>
                        <clipPath id="clip0_1_1120">
                            <rect width="32" height="32" fill="white" transform="translate(0.796875)" />
                        </clipPath>
                    </defs>
                </svg>
                <svg class="new-item-next" xmlns="http://www.w3.org/2000/svg" width="39" height="32"
                    viewBox="0 0 39 32" fill="none">
                    <path d="M36.7972 16L2.13058 16" stroke="white" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M36.7972 16L31.4639 21.3333" stroke="white" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M36.7972 16.0003L31.4639 10.667" stroke="white" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
            </div>
        </div>
