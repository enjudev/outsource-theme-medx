<section class="tw-py-100px">
    <div
        ...
        <div class="lg:tw-w-[45%]">
            <div class="tw-mt-43px tw-flex tw-items-center tw-justify-start tw-gap-7px">
            ...
            <p class="tw-mt-20px tw-text-base tw-leading-24px tw-text-gray3">Lorem ipsum dolor sit amet, consectetuer
                adipiscing
        ...
        <div class="tw-grid tw-grid-cols-2 tw-gap-30px">
            <img src="{{ asset('assets/exp1.png') }}" alt="">
            <img src="{{ asset('assets/exp1.png') }}" alt="">
            <img src="{{ asset('assets/exp1.png') }}" alt="">
            <img src="{{ asset('assets/exp1.png') }}" alt="">
        </div>
        <div
            class="tw-flex tw-items-stretch tw-justify-center tw-gap-15px tw-rounded-15px tw-bg-blue1 tw-px-15px tw-py-10px lg:tw-absolute lg:tw-bottom-22px lg:tw-left-0 lg:tw-gap-60px lg:tw-px-60px lg:tw-py-30px">
            <div class="tw-text-center">
                <p class="tw-text-24px tw-font-medium tw-text-white lg:tw-text-48px lg:tw-leading-48px">14K+</p>
                <p class="tw-my-4px tw-text-base tw-font-medium tw-text-white lg:tw-text-20px lg:tw-leading-28px">Happy
                    Customers</p>
            </div>
            <div class="tw-w-[1px] tw-bg-white"></div>
            <div class="tw-text-center">
                <p class="tw-text-24px tw-font-medium tw-text-white lg:tw-text-48px lg:tw-leading-48px">27K+</p>
                <p class="tw-my-4px tw-text-base tw-font-medium tw-text-white lg:tw-text-20px lg:tw-leading-28px">
                    Products
                    Sold</p>
            </div>
            <div class="tw-w-[1px] tw-bg-white"></div>
            <div class="tw-text-center">
                <p class="tw-text-24px tw-font-medium tw-text-white lg:tw-text-48px lg:tw-leading-48px">15+</p>
                <p class="tw-my-4px tw-text-base tw-font-medium tw-text-white lg:tw-text-20px lg:tw-leading-28px">Years
                    Experiences</p>
            </div>
        </div>
    </div>
